 ...
 */
    ...
    function transformContent(fobj = document.body) {
        ...
        for (var i = 0; i < obj.length; i++) {
            ...
            if (OO.nodeType == 3) { OO.data = transformText(OO.data, true) }
            else transformContent(OO)
        }
    }
    //功能：转换指定字符串；
